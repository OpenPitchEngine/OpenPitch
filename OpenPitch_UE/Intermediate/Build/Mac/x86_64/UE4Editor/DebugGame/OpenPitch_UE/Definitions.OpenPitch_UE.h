...
#define UE_PROJECT_NAME OpenPitch_UE
#define UE_TARGET_NAME OpenPitch_UEEditor
#define UE_MODULE_NAME "OpenPitch_UE"
...
#define OPENPITCH_UE_API DLLEXPORT
